...
urlpatterns = [
    url(r'^generate_fake_payments/(?P<number_of_payments>[0-9]+)', generate_fake_payments, name='generate_fake_payments'),
    ...
    url(r'^add_edit_category_action/$', add_edit_category_action, name='add_edit_category_action'),
    url(r'^delete_category_action/(?P<category_id>[0-9]+)', delete_category_action, name='delete_category_action'),
    url(r'^add_edit_category/(?P<category_id>[0-9]+)', add_edit_category, name='add_edit_category'),
    url(r'^edit_categories/$', edit_categories, name='edit_categories'),
    url(r'^edit_profile/$', edit_profile, name='edit_profile'),
    url(r'^edit_profile_action/$', edit_profile_action, name='edit_profile_action'),
